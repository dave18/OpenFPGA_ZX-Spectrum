...
# ACDS 18.1 625 win32 2024.11.29.16:12:26
# ----------------------------------------
...
# ----------------------------------------
# If mf_audio_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mf_audio_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mf_audio_pll.vo"
}
